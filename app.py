...
st.markdown(
    ...
    [data-testid="stSidebar"]{
        background: linear-gradient(180deg, #0f172a 0%, #172554 60%, #1e3a8a 100%);
    }
    [data-testid="stSidebar"] *{
...
if source_mode == "eBay Active API":
    ...
    st.caption("Column ขั้นต่ำ: title, price | แนะนำเพิ่ม currency, shipping, sold_date, item_url, condition")
...
if result_df.empty:
    ...
    table_tab, chart_tab, export_tab = st.tabs(["🧾 รายการราคา", "📈 กราฟ", "📥 Export"])
    with table_tab:
